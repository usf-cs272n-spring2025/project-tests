...
public class ProjectNextTests {
	...
	public void testThreadSpeedup() throws IOException {
		runJUnitTest(ThreadBuildTests.ThreadTests.class, "slowIndexSingleMulti");
	}
	...
	@Test
	@Tag("past-v1")
	@Tag("time-v1.0") @Tag("time-v1.1") @Tag("time-v1.2") @Tag("time-v1.3") @Tag("time-v1.4")
	@Tag("time-v2.0") @Tag("time-v2.1") @Tag("time-v2.2") @Tag("time-v2.3") @Tag("time-v2.4")
	@Tag("time-v4.0")
	@Tag("test-v5.0") @Tag("test-v5.1")
	@Tag("next-v4.1") @Tag("next-v4.2")
	@Tag("next-v5.0") @Tag("next-v5.1")
